...
CREATE TYPE "public"."assignment_source" AS ENUM('generated', 'manual');--> statement-breakpoint
...
ALTER TABLE "base_schedule" ADD CONSTRAINT "base_schedule_board_id_board_id_fk" FOREIGN KEY ("board_id") REFERENCES "public"."board"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "base_schedule" ADD CONSTRAINT "base_schedule_board_row_id_board_row_id_fk" FOREIGN KEY ("board_row_id") REFERENCES "public"."board_row"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "base_schedule" ADD CONSTRAINT "base_schedule_employee_id_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "board_crew" ADD CONSTRAINT "board_crew_board_id_board_id_fk" FOREIGN KEY ("board_id") REFERENCES "public"."board"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "board_crew" ADD CONSTRAINT "board_crew_employee_id_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "work_pattern" ADD CONSTRAINT "work_pattern_employee_id_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employee"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "work_pattern_day" ADD CONSTRAINT "work_pattern_day_work_pattern_id_work_pattern_id_fk" FOREIGN KEY ("work_pattern_id") REFERENCES "public"."work_pattern"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "base_schedule_board_idx" ON "base_schedule" USING btree ("board_id");--> statement-breakpoint
CREATE INDEX "base_schedule_employee_idx" ON "base_schedule" USING btree ("employee_id");--> statement-breakpoint
